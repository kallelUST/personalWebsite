              ...
              <div className="mx-auto max-w-md px-4 text-center sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                <div className="lg:py-24">
                  ...
                  <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                    My name is KALLEL Amine. I am a financial engineering
                    student at the Hong Kong University of Science and
                    Technology (HKUST). In this website, you will learn about
                    the skills that I have accumulated during my academic years.
                  </p>
